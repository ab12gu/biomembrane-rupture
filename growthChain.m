function [pins, invadedPins, MLVandBL] = ...
    growthChain(pins, invadedPins, frameSize, tension, pinThres, ...
    percReleased, max_rows, max_col, pinRad, xcen, ycen, MLVandBL, pinProb,... 
...
%   Detailed explanation goes here
    ...
    while(1)
        ...
        pins(4,q) = (tension - pinThres)*(1+percReleased);
        pins(8,q) = pins(8,q) + 1;
...
%%% Visual Output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            output(MLVandBL, pinProb, clusProb, maxRadius, ...
                frameSize, expRadius, videoSave, pins, MLVnodes);
