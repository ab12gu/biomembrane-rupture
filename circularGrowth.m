function[pins, invadedPins, MLVandBL, n] = ...
    circularGrowth(invadedPins, frameSize, tension, percReleased,...
    pins, P, xcen, ycen,  MLVandBL, max_rows, max_col)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            bondStr = pins(11,P);
            pins(4,P) = (tension - bondStr)*(1+percReleased/100);
            bondIncrease = pins(4,P);
            pins(11,P) = bondStr + bondIncrease;
